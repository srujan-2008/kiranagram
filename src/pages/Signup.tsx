...
import { Eye, EyeOff, Sparkles, Mail, Lock, User, ArrowRight, Chrome, Check } from "lucide-react";
      ...
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute bottom-12 left-12 right-12">
          <h2 className="text-3xl font-display font-bold mb-3">
            Start Your <span className="gradient-text-secondary">Creative Journey</span>
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-2">
              <input
                type="checkbox"
                required
                className="w-4 h-4 mt-1 rounded border-border bg-muted/50 text-primary focus:ring-primary/50"
              />
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-gradient-to-r from-secondary to-accent text-secondary-foreground font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-secondary/30 hover:scale-[1.02] active:scale-[0.98]"
            >
              Create Account
